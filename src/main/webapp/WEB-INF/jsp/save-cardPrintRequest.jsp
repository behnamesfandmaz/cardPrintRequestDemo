...
<div class="container">
    <form:form method="post" modelAttribute="cardPrintRequestDTO">
        <fieldset class="form-group">
            ...
            <form:input path="branchCode" name="branchCode" type="text"
                   class="form-control" required="required"/>
            <form:errors path="branchCode" cssClass="text-warning"/>
        </fieldset>
        <fieldset class="form-group">
            <form:label path="ipAddress">IpAddress</form:label>
            <form:input path="ipAddress" name="ipAddress" type="text"
                        class="form-control" required="required"/>
            <form:errors path="ipAddress" cssClass="text-warning"/>
        </fieldset>
<%--        <fieldset class="form-group">--%>
<%--            <form:label path="personnelCode">personnelCode</form:label>--%>
<%--            <form:input path="personnelCode" name="personnelCode" type="text"--%>
<%--                        class="form-control" required="required"/>--%>
<%--            <form:errors path="personnelCode" cssClass="text-warning"/>--%>
<%--        </fieldset>--%>
        <fieldset class="form-group">
